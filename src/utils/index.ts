...
export const vibrantColors = ['#dd7878', '#ea76cb', '#8839ef', '#e64553', '#fe640b', '#df8e1d', '#40a02b', '#209fb5', '#1e66f5', '#7287fd']
export function generateUUID(): string {
  return (new Date().getTime().toString(16) + Math.random().toString(16).substr(2)).substr(2, 16)
}
export const getRandomColor = () => vibrantColors[Math.floor(Math.random() * vibrantColors.length)]
